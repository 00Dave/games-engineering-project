...
int main (){
	...
	/*Play the bitchin background music*/
...
void createHouse() {
	...
	Object* fish = new Object("fish", vector3df(10.0f, 0.0f, 10.0f));//leave there
	...
	Collectable* socks = new Collectable("socks", vector3df(7.5f, 0.0f, 47.5f));
	...
	Collectable* shoes = new Collectable("shoes", vector3df(-5.0f, 0.0f, 5.0f));
	...
	Enemy* rabbit = new Enemy("rabbit", hallexit, vector3df(-27.0, 0.0f, 42.0f), 20.0f, carrot, jeans);
}